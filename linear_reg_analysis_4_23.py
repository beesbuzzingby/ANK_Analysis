...
from analyze_4_23 import df
from analyze_4_23 import item_spec
...
def results(file_name, df):
    with open(file_name, "w") as f:
        ...
        # print comm_sm.rsquared to get a more accurate r-squared value with more than 3 points after the decimal
